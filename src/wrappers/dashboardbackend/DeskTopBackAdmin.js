...
const DeskTopBackAdmin = () => {
  ...
  return (<Box sx={{ width: '100%'
            ...
            <ListItemButton sx={{justifyContent:"center" , backgroundColor:pathname === "/backend/room" || pathname === "/backend/" ? "#FBF1d5" : "#ffffff"}}>
                <Stack spacing={1} textAlign="center">
                    <Link to={"/manage/room"} style={{textDecoration: "none" , color:"#000"}}>
                        <ListItemIcon sx={{justifyContent:"center"}}>
                            <RoomPreferencesIcon />
                        </ListItemIcon>
            ...
            <ListItemButton sx={{justifyContent:"center" , backgroundColor:pathname === "/backend/experience" ? "#FBF1d5" : "#ffffff"}}>
                <Stack spacing={1} textAlign="center">
                    <Link to={"/manage/experience"} style={{textDecoration: "none" , color:"#000"}}>
                        <ListItemIcon sx={{justifyContent:"center"}}>
                            <GradingIcon />
                        </ListItemIcon>
            ...
            <ListItemButton sx={{justifyContent:"center" , backgroundColor:pathname === "/backend/gallery" ? "#FBF1d5" : "#ffffff"}}>
                <Stack spacing={1} textAlign="center">
                    <Link to={"/manage/gallery"} style={{textDecoration: "none" , color:"#000"}}>
                        <ListItemIcon sx={{justifyContent:"center"}}>
                            <CollectionsIcon />
                        </ListItemIcon>
            ...
            <ListItemButton sx={{justifyContent:"center" , backgroundColor:pathname === "/backend/events" ? "#FBF1d5" : "#ffffff"}}>
                <Stack spacing={1} textAlign="center">
                    <Link to={"/manage/events"} style={{textDecoration: "none" , color:"#000"}}>
                        <ListItemIcon sx={{justifyContent:"center"}}>
                            <EventNoteIcon />
                        </ListItemIcon>
            ...
            <ListItemButton sx={{justifyContent:"center" , backgroundColor:pathname === "/backend/promotion" ? "#FBF1d5" : "#ffffff"}}>
                <Stack spacing={1} textAlign="center">
                    <Link to={"/manage/promotion"} style={{textDecoration: "none" , color:"#000"}}>
                        <ListItemIcon sx={{justifyContent:"center"}}>
                            <CardMembershipIcon />
                        </ListItemIcon>
            ...
            <ListItemButton sx={{justifyContent:"center" , backgroundColor:pathname === "/backend/contact" ? "#FBF1d5" : "#ffffff"}}>
                <Stack spacing={1} textAlign="center">
                    <Link to={"/manage/contact"} style={{textDecoration: "none" , color:"#000"}}>
                        <ListItemIcon sx={{justifyContent:"center"}}>
                            <ContactSupportIcon />
                        </ListItemIcon>
            ...
            <Collapse in={open} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                    <ListItemButton sx={{justifyContent:"center" , backgroundColor:pathname === "/manage/category" ? "#FBF1d5" : "#ffffff"}}>
                        <Stack spacing={1} textAlign="center">
                            <Link to={"/manage/category"} style={{textDecoration: "none" , color:"#000"}}>
                                <ListItemIcon sx={{justifyContent:"center"}}>
                                    <CategoryIcon />
                                </ListItemIcon>
                    ...
                    <ListItemButton sx={{justifyContent:"center" , backgroundColor:pathname === "/manage/web" ? "#FBF1d5" : "#ffffff"}}>
                        <Stack spacing={1} textAlign="center">
                            <Link to={"/manage/web"} style={{textDecoration: "none" , color:"#000"}}>
                                <ListItemIcon sx={{justifyContent:"center"}}>
                                    <LanguageIcon />
                                </ListItemIcon>
...
export default DeskTopBackAdmin